...
$routes->post('/admin/propertyforleasemasterlist/markAsLeased', 'Admin\PropertyForLeaseMasterlistController::markAsLeased');
...
$routes->get('/admin/sold-property-masterlist', 'Admin\SoldPropertyMasterlistController::index');
$routes->get('/admin/soldpropertymasterlist/getData', 'Admin\SoldPropertyMasterlistController::getData');
$routes->delete('/admin/soldpropertymasterlist/delete/(:num)', 'Admin\SoldPropertyMasterlistController::delete/$1');
$routes->get('/admin/soldpropertymasterlist/propertyDetails', 'Admin\SoldPropertyMasterlistController::propertyDetails');
$routes->delete('admin/soldpropertymasterlist/deleteImage/(:num)', 'Admin\SoldPropertyMasterlistController::deleteImage/$1');
$routes->post('/admin/soldpropertymasterlist/unSold', 'Admin\SoldPropertyMasterlistController::unSold');
$routes->get('/admin/leased-property-masterlist', 'Admin\LeasedPropertyMasterlistController::index');
$routes->get('/admin/leasedpropertymasterlist/getData', 'Admin\LeasedPropertyMasterlistController::getData');
$routes->get('/admin/leasedpropertymasterlist/propertyDetails', 'Admin\LeasedPropertyMasterlistController::propertyDetails');
$routes->delete('/admin/leasedpropertymasterlist/delete/(:num)', 'Admin\LeasedPropertyMasterlistController::delete/$1');
$routes->delete('admin/leasedpropertymasterlist/deleteImage/(:num)', 'Admin\LeasedPropertyMasterlistController::deleteImage/$1');
$routes->post('admin/leasedpropertymasterlist/addLeasingUnit', 'Admin\LeasedPropertyMasterlistController::addLeasingUnit');
$routes->post('/admin/leasedpropertymasterlist/deleteLeasingUnit', 'Admin\LeasedPropertyMasterlistController::deleteLeasingUnit');
$routes->post('/admin/leasedpropertymasterlist/updateOrder', 'Admin\LeasedPropertyMasterlistController::updateOrder');
$routes->get('/admin/leasedpropertymasterlist/getLeasingUnitDetails', 'Admin\LeasedPropertyMasterlistController::getLeasingUnitDetails');
$routes->post('/admin/leasedpropertymasterlist/updateImageOrder', 'Admin\LeasedPropertyMasterlistController::updateImageOrder');
$routes->post('/admin/leasedpropertymasterlist/deleteImageLeasing', 'Admin\LeasedPropertyMasterlistController::deleteImageLeasing');
$routes->post('/admin/leasedpropertymasterlist/uploadLeasingImage', 'Admin\LeasedPropertyMasterlistController::uploadLeasingImage');
$routes->get('/admin/leasedpropertymasterlist/getLeasingImages', 'Admin\LeasedPropertyMasterlistController::getLeasingImages');
$routes->post('/admin/leasedpropertymasterlist/editLeasingUnit', 'Admin\LeasedPropertyMasterlistController::editLeasingUnit');
$routes->post('/admin/leasedpropertymasterlist/unLeased', 'Admin\LeasedPropertyMasterlistController::unLeased');
/*Administrator*/
