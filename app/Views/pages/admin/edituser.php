                        ...
                        <div class="card-body">
                            <form id="edituser">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname" id="firstname" class="form-control" placeholder="Enter Full Name" value="<?=$userDetails['firstname'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="lastname">Last Name</label>
                                    <input type="text" name="lastname" id="lastname" class="form-control" placeholder="Enter Full Name" value="<?=$userDetails['lastname'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="text" name="username" id="username" class="form-control" placeholder="Enter Full Name" value="<?=$userDetails['username'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="emailaddress">Email Address</label>
                                    <input type="text" name="emailaddress" id="emailaddress" class="form-control" value="<?=$userDetails['emailaddress'];?>" placeholder="Enter Email Address">
                                </div>
                                <div class="form-group">
