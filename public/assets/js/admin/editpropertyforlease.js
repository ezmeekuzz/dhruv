$(document).ready(function() {
    ...
    // Submit form handler
    $('#editpropertyforlease').submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/editpropertyforlease/update/' + formData.get('property_id'),
            data: formData,
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    function loadPropertyGalleries(propertyId) {
        $.ajax({
            url: '/admin/editpropertyforlease/getGalleries/' + propertyId,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                ...
                galleryContainer.on('click', '.delete-btn-preview', function() {
                    ...
                    $.ajax({
                        url: '/admin/editpropertyforlease/deleteGalleryFile',
                        type: 'POST',
                        data: {
    ...
    function updateGalleryIndices() {
        ...
        $.ajax({
            url: '/admin/editpropertyforlease/updateGalleryOrder',
            type: 'POST',
    ...
    function handleFiles(files) {
        ...
        $.ajax({
            url: '/admin/editpropertyforlease/uploadGalleryFile', // Adjust the URL to your route
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
