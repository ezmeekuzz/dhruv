                ...
                <div class="col-md-12 m-b-30">
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h1><i class="fa fa-building"></i> Leased Property Masterlist</h1>
                        </div>
                        <div class="ml-auto d-flex align-items-center">
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Leased Property Masterlist</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card card-statistics">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title"><i class="fa fa-building"></i> Leased Property Masterlist</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="datatable-wrapper table-responsive">
                                <table id="leasedpropertymasterlist" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Property Name</th>
                                            <th>Anchor Tenant</th>
...
<script src="<?=base_url();?>assets/js/admin/leasedpropertymasterlist.js"></script>