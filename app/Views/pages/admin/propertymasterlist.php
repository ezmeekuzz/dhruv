                ...
                <div class="col-md-12 m-b-30">
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h1><i class="fa fa-building"></i> Property Masterlist</h1>
                        </div>
                    ...
                    <div class="card card-statistics">
                        <div class="card-header">
                            <div class="card-heading">
                                <h4 class="card-title"><i class="fa fa-building"></i> Property Masterlist</h4>
                            </div>
                        </div>
                        <div class="card-body">
...
<script src="<?=base_url();?>assets/js/admin/propertymasterlist.js"></script>